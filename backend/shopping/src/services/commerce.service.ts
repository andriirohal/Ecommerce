...
import type { CreatePlantInput, Plant, UpdatePlantInput } from "../index";
import type { Result } from "../result";

import { isNonEmpty, isValidStock, fail, ok } from "../index";

export async function createPlant(pool: Pool, input: CreatePlantInput): Promise<Result<Plant>> {
